    ...
    <div>
      <div className="px-4 py-4 sticky top-0">
        <div className="flex items-center gap-3">
          ...
          <header>
            <h3 className="text-xl font-semibold">显示</h3>
          </header>
        </div>
      </div>
      <div className="border-t border-on-surface/30 py-4 px-4">
        <h3 className="font-semibold text-xl">颜色</h3>
      ...
      <div className="border-t border-on-surface/30 py-4 px-4">
        <h3 className="font-semibold text-xl">背景</h3>
          ...
          {themes.map((t) => (
            ...
            >
              ...
              <p className="capitalize font-semibold">
                {(() => {
                  if (t.name === 'light') return '浅色';
                  if (t.name === 'dark') return '深色';
                  return t.name;
                })()}
              </p>
            </div>
